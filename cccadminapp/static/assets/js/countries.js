...
function print_country(id_country){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var option_str = document.getElementById(id_country);
	option_str.length=0;
...
function print_state(id_state, id_state_index) {
    var option_str = document.getElementById(id_state);
    option_str.length = 0; // Clear existing options
    option_str.options[0] = new Option('Select State', '');
    option_str.selectedIndex = 0;

    var state_arr = s_a[id_state_index].split("|");

...
urlpatterns = [
    ...
    path('delete_restructure/<int:pk>/', views.delete_restructure, name='delete_p'),
    ...
    path('parish_register/', views.reg_parish, name='parish-registration'),
    path('all_parish/' , views.all_parish, name='all-parish'),
    path('edit/<int:pk>/', views.edit_parish_reg, name='edit-parish'),
    path('reg_parish/<int:pk>', views.regparish, name='reg-old-parish'),
